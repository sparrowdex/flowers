...
function LotusPetal({ width = 1, length = 1, angle = 0, colorHsl = [340, 100, 50] }) {
  ...
  return (
    <mesh geometry={geometry} rotation={[angle, 0, 0]}>
        ...
        <group ref={groupRef} position={position} scale={scale} rotation={rotation}>
            ...
            {[...Array(5)].map((_, i) => (
                <group key={`l1-${i}`} rotation={[0, (i/5)*Math.PI*2, 0]}>
                    <group position={[0, 0.1, 0.15]} rotation={[0.25, 0, 0]}>
                        <LotusPetal width={0.35} length={0.8} angle={-0.1} colorHsl={[330, 80, 50]} />
                    </group>
                </group>
            ))}
            {/* Middle Layer */}
            {[...Array(6)].map((_, i) => (
                <group key={`l2-${i}`} rotation={[0, ((i+0.5)/6)*Math.PI*2, 0]}>
                    <group position={[0, 0.1, 0.25]} rotation={[0.65, 0, 0]}>
                        <LotusPetal width={0.45} length={1.1} angle={-0.4} colorHsl={[340, 90, 60]} />
                    </group>
                </group>
            ))}
            {/* Open Outer Layer */}
            {[...Array(8)].map((_, i) => (
                <group key={`l3-${i}`} rotation={[0, (i/8)*Math.PI*2, 0]}>
                    <group position={[0, 0.05, 0.35]} rotation={[1.1, 0, 0]}>
                        <LotusPetal width={0.55} length={1.3} angle={-0.7} colorHsl={[345, 100, 70]} />
                    </group>
                </group>
            ))}
        </group>
